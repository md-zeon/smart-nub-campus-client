...
import type { Resource, PaginationMeta } from "@/types/resource.types";
...
/**
 * Inner resources page content — uses usePagination which requires Suspense.
 */
function ResourcesContent() {
  ...
  }, [page, debouncedSearch, selectedCategoryId, sortBy]);
...
/**
 * Resources list page using PageLayout with ResourcesSidebar (left) and ResourcesTrending (right).
 * Supports search, category/course/semester filters, tabs, and pagination.
 */
